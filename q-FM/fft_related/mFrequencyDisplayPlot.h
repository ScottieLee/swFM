...
//This is a fuctioning class for plot FFT spectrum.
...
class FrequencyDisplayPlot:public QwtPlot{
  Q_OBJECT
    ...
    // Public functions
public:
  FrequencyDisplayPlot(QWidget*);   //constructor
  virtual ~FrequencyDisplayPlot();  //destructor
  ...
  //The exact function plot FFT curves
